...
If you are using a diamond computer you can load python into your path to do this.
    ...
    >>> module load python
    >>> conda env create --prefix /path/to/env/doc-env --file /path/to/httomolib/docs/source/doc-conda-requirements.yml
...
While inside your virtual environment, run the sphinx-build.sh script.
    ...
    >>> source /path/to/httomolib/docs/sphinx-build.sh

The script will:

1. Remove previous api and build directories.
2. Generate current httomolib api files
...
You can view the completed pages by opening the httomolib/docs/build/index.html page inside a browser.
